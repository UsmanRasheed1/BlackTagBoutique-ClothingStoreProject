...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2024 at 05:54 PM
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `FindNextAvailable` () RETURNS INT(11)  BEGIN
    DECLARE next_available INT;
    
    SELECT MIN(Clothesid) + 1 INTO next_available
    FROM clothes
    WHERE Clothesid + 1 NOT IN (SELECT Clothesid FROM clothes);

    IF next_available IS NULL THEN
        SET next_available = (SELECT MAX(Clothesid) + 1 FROM clothes);
    END IF;
...
('example@gmail.com', '032123321670', 'ExampleAddress', 'Comment'),
('exmple12@gmail.com', '032123325570', 'ExampleAddress2', 'Example Comment'),
('k213225@nu.edu.pk', '032123441670', 'Bla Bla', 'Bla Bla Bla'),
('k214924@nu.edu.pk', '032123321670', 'ewfq', 'kjfs;kfn'),
('newuser@gmail.com', '03222231670', 'House No. 123, Street Name, City, Country', 'Near Y'),
('usmanrasheed2002@gmail.com', '03222231670', 'House No. 123', NULL);
...
(23, 'CLASSIC STRIPED COTTON SHIRT', 'Men', 1500, 'ProjectImages/23pink.webp'),
...
(23, 'Pink', 'ProjectImages/23pink.webp'),
(23, 'SeaGreen', 'ProjectImages/23seagreen.webp'),
...
(111, 'newemail@gmail.com', 16, 'FAUX SUEDE JACKET WITH SHERPA COLLAR', 'Black', 'XS', 1, 12000, 12000, 'ProjectImages/16black.webp'),
(215, 'usmanrasheed2002@gmail.com', 39, 'EMPATHY SWEATSHIRT', 'Purple', 'XS', 3, 2000, 6000, 'ProjectImages/39purple.webp'),
(235, 'usmanrasheed2002@gmail.com', 39, 'EMPATHY SWEATSHIRT', 'Black', 'XS', 6, 2000, 12000, 'ProjectImages/39black.webp'),
(243, 'usmanrasheed2002@gmail.com', 15, 'QUILTED GILET WITH CONTRAST DETAILS', 'Blue', 'XS', 3, 12000, 36000, 'ProjectImages/15blue.webp'),
(247, 'usmanrasheed2002@gmail.com', 17, 'FAUX SUEDE VARSITY BOMBER JACKET', 'Brown', 'M', 4, 18000, 72000, 'ProjectImages/17brown.webp'),
(251, 'usmanrasheed2002@gmail.com', 1, 'MENS T-SHIRT', 'Black', 'XS', 3, 400, 1200, 'ProjectImages/1black.webp'),
(252, 'usmanrasheed2002@gmail.com', 25, 'GRADIENT SLOGAN GRAPHIC T-SHIRT', 'Black', 'XS', 1, 1600, 1600, 'ProjectImages/25black.webp'),
(256, 'newuser@gmail.com', 38, 'MOON NECK SWEATER', 'Orange', 'XS', 1, 5000, 5000, 'ProjectImages/38orange.webp');
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_total_price` BEFORE UPDATE ON `my_cart` FOR EACH ROW BEGIN
    SET NEW.total_price = NEW.price * NEW.quantity;
END
$$
DELIMITER ;
...
('k213347@nu.edu.pk', 'Talha Minhaj', '21K3347'),
...
(38, 'usmanrasheed2002@gmail.com', 'Item 1\n QUILTED GILET WITH CONTRAST DETAILS Color: Blue Clothes Size: XS Quantity x Price = 1 x 12000 = 12000\nItem 2\n COTTON-LINEN SHIRT Color: White Clothes Size: XS Quantity x Price = 1 x 1200 = 1200\nDelivering to Usman Rasheed at Address: tfgyh , PhoneNumber: 03001234567 , Comments: sd\n', 13200, '2024-03-11 21:16:24'),
(53, 'usmanrasheed2002@gmail.com', 'Item 1\nFAUX SUEDE JACKET WITH SHERPA COLLAR Color: Brown Clothes Size: XS Quantity x Price = 1 x 12000 = 12000\nItem 2\nHALF FANCY SUMMER DRESS Color: Yellow Clothes Size: XS Quantity x Price = 1 x 1300 = 1300\nDelivering to Usman Rasheed at Address: Example Address, PhoneNumber: 03222231670, Comments: ads', 13300, '2024-03-14 17:15:38'),
(54, 'usmanrasheed2002@gmail.com', 'Item 1\nSKATER FIT JEANS Color: Green Clothes Size: XS Quantity x Price = 1 x 3500 = 3500\nDelivering to Usman Rasheed at Address: Example Address, PhoneNumber: 03222231670, Comments: ads', 3500, '2024-03-15 15:36:07'),
(55, 'usmanrasheed2002@gmail.com', 'Item 1\nEMPATHY SWEATSHIRT Color: Purple Clothes Size: M Quantity x Price = 3 x 2000 = 6000\nItem 2\nEMPATHY SWEATSHIRT Color: Purple Clothes Size: S Quantity x Price = 3 x 2000 = 6000\nDelivering to Usman Rasheed at Address: hdggh, PhoneNumber: 03222231670, Comments: ghghghgh', 12000, '2024-04-01 20:16:21'),
(56, 'usmanrasheed2002@gmail.com', 'Item 1\nEMPATHY SWEATSHIRT Color: Black Clothes Size: XS Quantity x Price = 1 x 2000 = 2000\nDelivering to Usman Rasheed at Address: hdggh, PhoneNumber: 03222231670, Comments: ghghghgh', 2000, '2024-04-01 20:16:50'),
(57, 'usmanrasheed2002@gmail.com', 'Item 1\nFAUX LEATHER OVERSIZED JACKET Color: Blue Clothes Size: L Quantity x Price = 3 x 19000 = 57000\nDelivering to Usman Rasheed at Address: House No. 123, PhoneNumber: 03222231670, Comments: ', 57000, '2024-04-10 18:02:30'),
(58, 'usmanrasheed2002@gmail.com', 'Item 1\nQUILTED GILET WITH CONTRAST DETAILS Color: Brown Clothes Size: XS Quantity x Price = 1 x 12000 = 12000\nItem 2\nLINEN BRAND SHORTS Color: Pink Clothes Size: XS Quantity x Price = 1 x 1200 = 1200\nItem 3\nPLAIN SWEATSHIRT WITH ZIPPER OPENING Color: Red Clothes Size: M Quantity x Price = 2 x 5000 = 10000\nDelivering to Usman Rasheed at Address: House No. 123, PhoneNumber: 03222231670, Comments: ', 23200, '2024-04-14 23:47:24'),
(59, 'newuser@gmail.com', 'Item 1\nSKATER FIT JEANS Color: Green Clothes Size: XS Quantity x Price = 1 x 3500 = 3500\nDelivering to New User at Address: House No. 123, Street Name, City, Country, PhoneNumber: 03222231670, Comments: Near Y', 3500, '2024-04-16 18:49:47'),
(60, 'newuser@gmail.com', 'Item 1\nMOON NECK SWEATER Color: Blue Clothes Size: L Quantity x Price = 1 x 5000 = 5000\nDelivering to New User at Address: House No. 123, Street Name, City, Country, PhoneNumber: 03222231670, Comments: Near Y', 5000, '2024-04-16 18:51:01');
...
('blabla@gmail.com', 'Muhammad Usman', 'Rasheed', '1234'),
('email@gmail.com', 'A', 'V', 'Example123'),
('Example123@gmail.com', 'Muhammad Usman', 'AAA', 'Example123'),
...
('i@gmail.com', 'Muhammad Usman', 'Rasheed', '123'),
('k213225@nu.edu.pk', 'A', 'B', 'Example123'),
('k214924@nu.edu.pk', 'Muneeb', 'Ali', 'Muneeb'),
('newemail@gmail.com', 'Muhammad Usman', 'Rasheed', 'Example'),
('newuser@gmail.com', 'New', 'User', 'Pass1234'),
('us@gmail.com', 'Muhammad Usman', 'Rasheed', '123'),
('Usman2@gmail.com', 'Muhammad Usman', 'Rasheed', '123'),
('Usman@gmail.com', 'Muhammad Usman', 'Rasheed', '123'),
...
--
ALTER TABLE `receipts`
  MODIFY `ReceiptID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
